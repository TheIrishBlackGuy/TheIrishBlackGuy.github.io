...
function setup() {
  ...
  g = new game(color(random(144, 224), random(144, 224), random(144, 224)), 0, 0, 9);
...
function draw() {
  ...
  if (mouseX > 70 && mouseX < 560 && mouseY > 900 && mouseY < 990) {
    console.log('color');
  }
  ...
  for (let i = 0; i < b.length; i++) {
    ...
    if (key == 'h') {
      console.log('X' + round(mouseX) + ' and Y' + round(mouseY));
    }

    //w
    if (mouseX > 105 && mouseX < 165 && mouseY > 590 && mouseY < 650) {
      console.log('www');
      b[i].moveW();
    }
    //a
    if (mouseX > 50 && mouseX < 110 && mouseY > 645 && mouseY < 705) {
      console.log('aaa');
      b[i].moveA();
    }
    //s
    if (mouseX > 105 && mouseX < 165 && mouseY > 700 && mouseY < 760) {
      console.log('sss');
      b[i].moveS();
    }
    //d
    if (mouseX > 160 && mouseX < 220 && mouseY > 645 && mouseY < 705) {
      console.log('ddd');
      b[i].moveD();
    }

    //q
    if (mouseX > 57 && mouseX < 103 && mouseY > 597 && mouseY < 643) {
      console.log('qqq');
      b[i].moveWA();
    }
    //e
    if (mouseX > 167 && mouseX < 213 && mouseY > 597 && mouseY < 643) {
      console.log('eee');
      b[i].moveWD();
    }
    //z
    if (mouseX > 57 && mouseX < 103 && mouseY > 707 && mouseY < 753) {
      console.log('zzz');
      b[i].moveSA();
    }
    //c
    if (mouseX > 167 && mouseX < 213 && mouseY > 707 && mouseY < 753) {
      console.log('ccc');
      b[i].moveSD();
    }

    //go
    if (mouseX > 485 && mouseX < 555 && mouseY > 595 && mouseY < 665) {
      console.log('ggg');
      b[i].moveGo();
    }
    //stop
    if (mouseX > 415 && mouseX < 485 && mouseY > 685 && mouseY < 755) {
      console.log('ppp');
      b[i].moveStop();
    }
