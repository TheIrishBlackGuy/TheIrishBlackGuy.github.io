...
function checkInput1() {
    ...
    if (userN === "scorpion" || userN === "Scorpion" || userN === "SCORPION") {
        document.location = 'solved-green.html';
    } else alert("Wrong order. Try again");
}
function checkInput2() {
    var userN = document.getElementById('username2').value;
    if (userN === "worm" || userN === "Worm" || userN === "WORM") {
        document.location = 'solved-green.html';
    } else alert("Wrong order. Try again");
}
function checkInput3() {
    var userN = document.getElementById('username3').value;
    if (userN === "snail" || userN === "Snail" || userN === "SNAIL") {
        document.location = 'solved-green.html';
    } else alert("Wrong order. Try again");
}
function checkInput4() {
    var userN = document.getElementById('username4').value;
    if (userN === "butterfly " || userN === "Butterfly " || userN === "BUTTERFLY") {
        document.location = 'solved-green.html';
    } else alert("Wrong order. Try again");
}
...
function checkInput6() {
    var userN = document.getElementById('username6').value;
    if (userN === "roly-poly" || userN === "Roly-poly" || userN === "Roly-Poly" || userN === "ROLY-POLY" || userN === "rolypoly" || userN === "Rolypoly" || userN === "RolyPoly" || userN === "ROLYPOLY") {
        document.location = 'solved-green.html';
    } else alert("Wrong order. Try again");
}
function checkInput7() {
    var userN = document.getElementById('username7').value;
    if (userN === "spider" || userN === "Spider" || userN === "SPIDER") {
        document.location = 'solved-green.html';
    } else alert("Wrong order. Try again");
}
