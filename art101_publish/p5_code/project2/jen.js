...
function draw() {
// if (250){ 
//  image(fish, 0, 0,850,650);

// } else if (500){
//  image(lilypad, 0, 0,850,650);

// } else {
//  image(water, 0, 0,850,650);
...
// }
 image(water, 0, 0,850,650);
  ...
  // recordit();
console.log(round(frameCount/50));
}
...
Boid.prototype.render = function() {
  ...
  beginShape();
if (frameCount/50 > 5 && frameCount/50 < 10){ 
  image(fish, 0, -this.r * 2, 40,40);
  // image(fish, -this.r, this.r * 2, 40,40);
  // image(fish, this.r, this.r * 2, 40,40);
} else if (frameCount/50 > 10){
  image(lilypad, 0, -this.r * 2, 40,40);
  // image(lilypad, -this.r, this.r * 2, 40,40);
  // image(lilypad, this.r, this.r * 2, 40,40);
} else {
  image(water, 0, -this.r * 2, 40,40);
  // image(water, -this.r, this.r * 2, 40,40);
  // image(water, this.r, this.r * 2, 40,40);
}
  endShape(CLOSE);
